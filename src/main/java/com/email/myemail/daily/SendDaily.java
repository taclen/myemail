package com.email.myemail.daily;
...
//		InternetAddress receiveAddress = new InternetAddress(
//				"liujia@fastech.com.cn", "刘佳", "utf-8");
		// 设置邮件接收方
...
//        String content = "this is a test email.";
		...
		helper.addAttachment("hhh.xlsx", new File("D:\\Documents\\Desktop\\现网环境.xlsx"));
		helper.setText("\n " + m+day + " 工作内容：\n\n"+content + "\n" + footer, false);
